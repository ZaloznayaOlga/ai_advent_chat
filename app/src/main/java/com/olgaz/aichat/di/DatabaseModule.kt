...
object DatabaseModule {
    ...
    fun provideChatDatabase(
        ...
        return Room.databaseBuilder(
            ...
            .addMigrations(ChatDatabase.MIGRATION_2_3, ChatDatabase.MIGRATION_3_4, ChatDatabase.MIGRATION_4_5, ChatDatabase.MIGRATION_5_6, ChatDatabase.MIGRATION_6_7, ChatDatabase.MIGRATION_7_8)
